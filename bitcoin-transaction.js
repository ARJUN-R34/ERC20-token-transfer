...
function getBalance(addr, options) {
    ...
    if (options.network == null) options.network = "testnet";
...
sendTransaction({ from: 'mpfZPE7GmGevx2GEySkWGfHyLnYgzP8EsN', to: 'muAYQq5ZsbkwBzHo9A872Ds1ScbfjY3ZjQ', btc: 0.0001, privKeyWIF: 'cV1uRKJsJs8qNR7Z1Usq51iHTYc1CcRAkj5LUn6QwhguLQ8iCUrA'});
...
// tail laugh juice galaxy solution fly giraffe color airport caution lamp shoulder
// screen claw alley slab knife wonder online say lesson iron sponsor plastic